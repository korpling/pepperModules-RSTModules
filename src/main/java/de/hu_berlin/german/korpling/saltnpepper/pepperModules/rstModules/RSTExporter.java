 ...
 *
 */
@Component(name="RSTExporterComponent", factory="PepperExporterComponentFactory")
@Service(value=PepperExporter.class)
public class RSTExporter extends PepperExporterImpl implements PepperExporter
{
	public RSTExporter()
	{
		super();
