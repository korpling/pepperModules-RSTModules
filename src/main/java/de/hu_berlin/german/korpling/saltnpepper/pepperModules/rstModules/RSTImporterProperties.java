...
public class RSTImporterProperties extends PepperModuleProperties 
{
	...
	/**
	 * Name of the property to add a a separator like a blank between the text of segments, when it is concatenated to the primary text in {@link STextualDS}. 
	 * For instance the segment text 'Is' of segment1 and the segment text 'this' of segment2 will be concatenated to an sText value 'is'SEPARATOR'this'.
	 */
